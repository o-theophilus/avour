 ...
 * Mon Sep 13 2021 23:21:21 GMT+0100 (West Africa Standard Time)
...
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
    ...
    (function() {
  setHTMLElemAttribute('innerHTML', Math.round(_initGlob.percentage), 'loading_text', true);
...
_initGlob.output.initOptions.preloaderEndCb = function() {
    ...
    (function() {
  setCSSRuleStyle('display', 'none', '#loading', true, '');
  setCSSRuleStyle('display', 'block', '#loading_btn', true, '');
})();
};
...
var maxIntDist, video, picked_object, action_02, x1, action_01, pickedObj, time, x2, point, dist, goto, screen_active, dura, lookat;
...
registerOnHover(['GROUP', 'action.show.panel'], false, function() {
  if (getDistanceBetweenObjects(getActiveCamera(), _pGlob.hoveredObject) < maxIntDist) {
    ...
    bindHTMLObject(_pGlob.hoveredObject, 'panel_float', true);
  }
}, function() {
