 ...
 * Sun Sep 12 2021 08:47:37 GMT+0100 (West Africa Standard Time)
...
_initGlob.output.initOptions.preloaderProgressCb = function(percentage) {
  ...
  setCSSRuleStyle('width', String(Math.round(_initGlob.percentage)) + '%', '#loading_bar', true, '');
})();
};
_initGlob.output.initOptions.preloaderEndCb = function() {
    _initGlob.percentage = 100;
    (function() {
  setCSSRuleStyle('display', 'none', '#splash_screen', true, '');
  setCSSRuleStyle('display', 'block', '#ui', true, '');
})();
};
...
function click() {
  ...
  if (getDistanceBetweenObjects(getActiveCamera(), picked_object) < maxIntDist) {
    if (action_02 == 'action.tv') {
      ...
      setCSSRuleStyle('opacity', '1', '#panel_static', true, '');
    }
  }
}
...
registerOnClick(['GROUP', 'action.show.panel'], false, false, [0,1,2], function() {
  ...
  setCSSRuleStyle('opacity', '0', '#panel_static', true, '');
});
