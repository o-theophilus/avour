 ...
 * Tue Sep 14 2021 23:48:10 GMT+0100 (West Africa Standard Time)
...
var x, maxIntDist, video, picked_object, action_02, x1, action_01, pickedObj, time, x2, point, goto, dist, dura, screen_active, lookat;
...
function log(x) {
  setHTMLElemAttribute('innerHTML', [getHTMLElemAttribute('innerHTML', 'log', true),'<br>',x,'-',dura,'-',dist].join(''), 'log', true);
}
