 ...
 * Wed Sep 15 2021 21:20:22 GMT+0100 (West Africa Standard Time)
...
_initGlob.output.initOptions.preloaderEndCb = function() {
    ...
    (function() {
  setHTMLElemAttribute('innerHTML', 'Enter Shop', 'loading_text', true);
...
var maxIntDist, video, picked_object, action_02, x1, action_01, pickedObj, time, x2, goto, point, screen_active, dist, dura, lookat;
...
function log() {
  setHTMLElemAttribute('innerHTML', [getHTMLElemAttribute('innerHTML', 'log', true),'<br>',toFixedPoint(dist, 3),' - (',x1,') - (',x2,')'].join(''), 'log', true);
}
