 ...
 * Tue Sep 14 2021 22:57:43 GMT+0100 (West Africa Standard Time)
...
var x, maxIntDist, video, picked_object, action_02, x1, action_01, pickedObj, time, x2, point, goto, dist, screen_active, dura, lookat;
...
// Describe this function...
function log(x) {
  setHTMLElemAttribute('innerHTML', [getHTMLElemAttribute('innerHTML', 'log', true),'<br>',x].join(''), 'log', true);
}
