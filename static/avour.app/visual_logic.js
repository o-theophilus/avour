 ...
 * Sun Sep 19 2021 08:40:18 GMT+0100 (West Africa Standard Time)
...
var maxIntDist, video, i, mat_count, picked_object, action_02, x1, action_01, pickedObj, mat_used, time, x2, point, goto, pickedObj_name, screen_active, dist, dura, lookat;
...
eventHTMLElem('click', 'panel_static_goto_details', true, function(event) {
  ...
  setCSSRuleStyle('display', 'inline-block', '#profile_close', true, '');
  setCSSRuleStyle('display', 'none', '#panel_static', true, '');
...
eventHTMLElem('click', 'profile_close', true, function(event) {
  ...
  setCSSRuleStyle('display', 'none', '#profile_close', true, '');
